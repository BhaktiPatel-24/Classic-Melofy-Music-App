...
class K_pop: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let searchTerms = ["bts", "jungkook", "jimin", "v", "rm", "suga", "j-hope", "jin"]
    ...
    override func viewDidLoad() {
        ...
        fetchsSongs(search: searchTerms[0])
    }
    ...
    func fetchsSongs(search: String) {
